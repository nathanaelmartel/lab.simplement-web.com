  ...
  <body>
    ...
    <?php require_once $_SERVER['DOCUMENT_ROOT'].'/_header.php'; ?>
        ...
        <section id="content">
            ...
            <h2><a href="https://github.com/nathanaelmartel/lab.simplement-web.com/blob/master/vendor/nathanaelmartel/Password.php" target="_blank">Passwords generator</a></h2>
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <select name="strength" id="strength">
                            <option value="0" <?php if (isset($_POST['strength']) && (0 == $_POST['strength'])): ?>selected="selected"<?php endif; ?>>Lettres minuscules</option>
                            <option value="1" <?php if (isset($_POST['strength']) && (1 == $_POST['strength'])): ?>selected="selected"<?php endif; ?>>Lettres minuscules et majuscules</option>
                            <option value="2" selected="selected">Lettres et chiffres</option>
                            <option value="3" <?php if (isset($_POST['strength']) && (3 == $_POST['strength'])): ?>selected="selected"<?php endif; ?>>Lettres, chiffres et caractères spéciaux</option>
                        </select>
                    </p>
